...
public class ThirdFragment extends Fragment {
    ...
    private static final String YOUTUBE_VIDEO_ID_1 = "h6w7Dh-QxzY";
    private static final String YOUTUBE_VIDEO_ID_2 = "gJAMYJkA2Uc";
    private static final String YOUTUBE_VIDEO_ID_3 = "_zxhK3Z-R0c";
    private static final String YOUTUBE_VIDEO_ID_4 = "0pdqf4P9MB8";
