...
public class SecondFragment extends Fragment {
    ...
    private static final String YOUTUBE_VIDEO_ID_1 = "uOuNeBIiYZE";
    private static final String YOUTUBE_VIDEO_ID_2 = "QqVFXyaRL90";
    private static final String YOUTUBE_VIDEO_ID_3 = "rF1F9dIbNqM";
    private static final String YOUTUBE_VIDEO_ID_4 = "NBr_ujFlmq8";
